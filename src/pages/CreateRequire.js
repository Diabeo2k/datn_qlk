        ...
        <div className="rq-container">
          <form action="">
            <div class="form-group">
              <h2 class="heading">REQUIRE FORM </h2>
              <div class="controls">
                ...
                <div class="col-1-4 col-1-4-sm">
                  <div class="controls">
                    ...
                    <label for="arrive" class="label-date">
                      <i class="fa fa-calendar"></i>&nbsp;&nbsp;Arrive
                    </label>
                  </div>
                </div>
                <div class="col-1-4 col-1-4-sm">
              ...
              <div class="grid">
                ...
                <div class="col-1-3 col-1-3-sm">
                  <div class="controls">
                    ...
                    <select class="floatLabel">
                      <option value="blank"></option>
                      <option value="single-bed">Vinfat</option>
                      <option value="double-bed" selected>
                        Doppelbett
                      </option>
                    </select>
                    <label for="fruit">BMW</label>
                  </div>
                </div>
              </div>
              <div class="grid">
